...
second_moment_path = np.memmap(filename = mem_file, dtype='float32', mode='r', shape=(512**2,512**2))
'''
fig, ax = plt.subplots()
im = ax.imshow(1000*first_moment_path.reshape(512, 512), cmap='Greys', aspect='auto')
...
for sub_i in range(512):
    ...
    for sub_j in range(512):
        ...
        second_moment_path[sec_st_i : sec_en_i,  sec_st_j : sec_en_j] = second_moment_path[sec_st_i : sec_en_i,  sec_st_j : sec_en_j] - mul_exp
